...
import 'package:echo/screens/settings_screen.dart';
    ...
    return BlocBuilder<UserBloc, UserBlocState>(
      builder: (context, state) {
        if (state is UserBlocLoadingState) {
          ...
          log("WIDGET UID ${widget.uid} || currentUid : $currentUserId");
          if (widget.uid == null) {
            widget.uid = state.userData.uid;
            log("uid iS ${widget.uid}");
          }
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: TabBarView(children: [
                      ...
                      ListView.builder(
                        itemCount: user.posts!.text.length,
                        itemBuilder: (context, index) => InkWell(
                          ...
                          child: postCard(
                            ...
                            uid: currentUserId!,
                            token: token,
                            postId: "${user.posts!.text[index]['postId']}",
                            username: "${user.username}",
                            profileUrl: "${user.profileImage}",
                            content: "${user.posts!.text[index]['content']}",
                            postType: "Text",
                            comments: user.posts!.text[index]["comments"],
                            likes: user.posts!.text[index]["likes"],
                          ),
                        ),
                      )
                    ]),
